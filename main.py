...
character = Character(screen, 600, 450, "assets/character_textures", characterAssets, 0.5, "character", copy.deepcopy(ItemInit.testSword), copy.deepcopy(ItemInit.testBow), [copy.deepcopy(ItemInit.testSingleUse), 3], 100)
